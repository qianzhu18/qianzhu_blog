import { APPEARANCE, LANG, NOTION_PAGE_ID, THEME, FORCE_THEME } from '@/blog.config'
import {
  THEMES,
  getThemeConfig,
  initDarkMode,
...
export function GlobalContextProvider(props) {
  ...
  const [theme, setTheme] = useState(FORCE_THEME || NOTION_CONFIG?.THEME || THEME) // 默认博客主题（FORCE_THEME最高优先级）
  ...
  useEffect(() => {
    ...
    const currentTheme = FORCE_THEME || router?.query?.theme || theme
